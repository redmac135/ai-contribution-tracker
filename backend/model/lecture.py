from mongoengine import Document, StringField, ListField, EmbeddedDocument, EmbeddedDocumentField, IntField, DateField, ObjectIdField
...
class Lecture(Document):
    ...
    contrib = ListField(EmbeddedDocumentField(Contribution), required=True)  # List of contributions
